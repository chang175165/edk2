...
#ifndef _I3C_ACCESS_REGS_H_
#define _I3C_ACCESS_REGS_H_
...
// DISINT bit0: 0 = No Action; 1 = Disable IBI Interrupt
// DISMR  bit1: 0 = No Action; 1 = Disable Mastership Request
// DISHJ  bit3: 0 = No Action; 1 = Disable Hot Join
#define BROADCAST_DISEC_LEN            1
#define BROADCAST_DISEC_DATA           (BIT0 | BIT1 | BIT3)
...
#define  I3C_INTR_STATUS_ENABLE_ALL    (UINT32)0xC63F
#define  I3C_INTR_SIGNAL_ENABLE_ALL    (UINT32)0xC63F
...
//
// SCL Low MST Timeout Count
//
#define  SCL_LOW_MST_TIMEOUT_COUNT 0x4C4B40  // 50ms
